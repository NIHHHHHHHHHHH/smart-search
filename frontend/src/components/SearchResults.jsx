...
// import React from 'react';
// import { Search, Frown, FileText, Users, Clipboard, Clock, Star, File } from 'lucide-react';

// /**
//  * SearchResults Component
//  * 
//  * Displays search results with different states: loading, empty, no results, and results list.
//  * Shows document cards with metadata, category badges, and relevance scores.
//  */
// const SearchResults = ({ results, loading, query, onDocumentClick }) => {
//   /**
//    * Loading State
//    * Shows animated skeleton placeholders while fetching results
//    */
//   if (loading) {
//     return (
//       <div className="space-y-4">
...
//   /**
//    * Empty State
//    * Shown when no search query has been entered yet
//    */
//   if (!query) {
//     return (
...
//         <p className="text-slate-600">Enter keywords to find relevant documents instantly</p>
//       </div>
//     );
//   }
...
//   /**
//    * No Results State
//    * Shown when search query returns no matching documents
//    */
//   if (results.length === 0) {
//     return (
//       <div className="text-center py-16 bg-white rounded-xl border border-slate-200">
...
//    * Used for category badges to provide visual distinction
//    */
//   const getCategoryColor = (category) => {
//     const colors = {
//       Strategy: 'bg-blue-100 text-blue-700',
...
//    * Provides visual indication of document format (PDF, DOC, etc.)
//    */
//   const getFileIcon = (fileType) => {
//   switch (fileType.toLowerCase()) {
//     case 'pdf':
...
//   /**
//    * Results Display
//    * Shows list of matching documents with full metadata
//    */
//   return (
//     <div>
...
//                 {/* Metadata row: team, project, date, relevance score */}
//                 <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500">
//                   {/* Team information */}
//                   <div className="flex items-center space-x-1">
//                     <Users className="w-4 h-4" />
